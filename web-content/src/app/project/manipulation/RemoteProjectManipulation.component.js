...
var RemoteProjectManipulationComponent = /** @class */ (function (_super) {
    __extends(RemoteProjectManipulationComponent, _super);
    function RemoteProjectManipulationComponent(projectService, localReachService, localProjectService) {
        return _super.call(this, projectService, localReachService, localProjectService) || this;
    }
    RemoteProjectManipulationComponent = __decorate([
        core_1.Component({
    ...
    return RemoteProjectManipulationComponent;
}(ProjectManipulation_component_1.ProjectManipulationComponent));
exports.RemoteProjectManipulationComponent = RemoteProjectManipulationComponent;
//# sourceMappingURL=RemoteProjectManipulation.component.js.map