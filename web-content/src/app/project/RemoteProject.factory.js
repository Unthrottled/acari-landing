...
var RemoteProjectFactory = /** @class */ (function () {
    ...
    RemoteProjectFactory.prototype.createProject = function (json) {
        ...
        var background = new Background_model_1.Background(json.background._colorOne, json.background._colorTwo, json.background._textColor, json.background._hostNameColor, json.background._pwdColor, json.background._titleColor, json.background._hoverColor, json.background._caretSolidColor, json.background._caretBlurredStyle);
